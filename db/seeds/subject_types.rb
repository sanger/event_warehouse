...
SUBJECT_TYPES = [
  ...
  [
    'plate',
    'A physical piece of labware, represented by a human readable barcode'
  ],
  [
    'sample',
    'Extracted DNA of RNA which will subsequently be subject to lab processes'
  ],
  [
    'order',
  ...
  [
    'project',
    'Represents a cost-code and other financial groupings'
  ],
  [
    'submission',
