...
ActiveRecord::Schema.define(version: 20_151_007_115_447) do
  create_table 'event_types', force: :cascade do |t|
    t.string   'key',         limit: 255, null: false, comment: 'The identifier for the event'
    t.text     'description', limit: 65_535, null: false, comment: 'A description of the meaning of the event'
  ...
  create_table 'role_types', force: :cascade do |t|
    ...
    t.text     'description', limit: 65_535, null: false, comment: 'A description of the role'
    t.datetime 'created_at'
    t.datetime 'updated_at'
  end
  ...
  create_table 'subject_types', force: :cascade do |t|
    t.string   'key',         limit: 255, null: false, comment: 'The identifier for the role type'
    t.text     'description', limit: 65_535, null: false, comment: 'A description of the subject type'
    t.datetime 'created_at'
    t.datetime 'updated_at'
  end
